...
class Files extends Field
{
	...
	protected $view = 'admin.form.files';
    /**
     * Css.
     *
     * @var array
    ...
    protected static $css = [
        ...
        '/js/bootstrap-fileinput/css/fileinput.min.css?v=5.0.4',
		'/js/bootstrap-fileinput/themes/explorer-fas/theme.min.css?v=5.0.4',
    ];
     ...
     */
    protected static $js = [
        '/js/bootstrap-fileinput/js/plugins/piexif.min.js',
        '/js/bootstrap-fileinput/js/fileinput.min.js?v=5.0.4',
        '/js/bootstrap-fileinput/js/plugins/sortable.min.js?v=5.0.4',
		'/js/bootstrap-fileinput/js/locales/zh.js?v=5.0.4',
		'/js/bootstrap-fileinput/themes/explorer-fas/theme.min.js?v=5.0.4',
    ];
    ...
    public function __construct($column, $arguments = [])
    {
		...
		$this->sortable();
		$this->removable();
		$this->options(['language'=>'zh','maxFileCount'=>20]);
